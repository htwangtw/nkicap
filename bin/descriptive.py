...
def plot_demo(
    datapath="data/enhanced_nki.tsv", basepath="results/descriptive"
):
    """check demographic"""
...
def plot_capcorr(
    ...
    basepath="results/descriptive/cap_correlation",
):
...
def plot_corr(
    ...
    sns.heatmap(
        sc[0][-16:, 2:-16], center=0, annot=False, square=True, linewidths=0.02
    )
    plt.title("correlation")
    plt.tight_layout()
